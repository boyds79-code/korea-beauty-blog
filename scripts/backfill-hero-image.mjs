...
//
// 예:
//   node scripts/backfill-hero-image.mjs korean-skincare-routine-order-explained "korean skincare products flatlay"
//   (이미 이미지가 있는 글의 사진을 바꾸고 싶을 때는 --force 추가)
//   node scripts/backfill-hero-image.mjs korean-skincare-routine-order-explained "korean skincare products flatlay" --force
